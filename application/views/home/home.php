        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hidden-xs">
            <div id="carousel-299058" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item"> <img class="img-responsive" src="<?php  echo base_url($hot_activity[$hot_activity_count]['poster']);?>"
                     alt="thumb">
                        <div class="carousel-caption"><?php echo $hot_activity[$hot_activity_count]['name'];
                            $hot_activity_count++;?></div>
                    </div>
                    <div class="item active"> <img class="img-responsive" src="<?php  echo base_url($hot_activity[$hot_activity_count]['poster']);?>" alt="thumb">
                        <div class="carousel-caption"><?php echo $hot_activity[$hot_activity_count]['name'];
                            $hot_activity_count++;?></div>
                    </div>
                    <div class="item"> <img class="img-responsive" src="<?php  echo base_url($hot_activity[$hot_activity_count]['poster']);?>" alt="thumb">
                        <div class="carousel-caption"><?php echo $hot_activity[$hot_activity_count]['name'];
                            $hot_activity_count++;?></div>
                    </div>
                </div>
            ...
            -->
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        <div class="thumbnail">
                            <a href="html/details_page.html"><img src="img/400X200.gif" alt="Thumbnail Image 1" class="img-responsive"></a>
                            <div class="caption">
                                <a class="hd_title_block" href="html/details_page.html">
                                    <h3 class="hd_title"><?php  echo base_url($recommended_activity[$recommended_activity_count]['poster']);?></h3>
                                </a>
                                <hr>
