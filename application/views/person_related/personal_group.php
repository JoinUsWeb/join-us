            <div class="personal_data personal_hd">
                <div class="personal_hd_joined">
                    ...
                    if (isset($joined_groups) && !empty($joined_groups)):
                            ...
                            <div class="p_group_main">
                                <div class="g_leftbar">
                                    ...
                                    <div class="group_infor">       <!--小组简介-->
                                        <a class="#"
                                           href="<?php echo site_url('user/group_detail/' . $joined_group_item['id']); ?>">
                                ...
                                <div class="g_rightbar">
                                    <div class="group_posts g_width_lg">       <!--小组公告-->
                                        <h3>小组公告</h3>
                                        <hr>
                                    ...
                                    <div class="group_details_button">
                                        <a class="thisover"
                                           href="<?php echo site_url('user/group_detail/' . $joined_group_item['id']); ?>">小组详情<i
                        ...
                        <div class="hd_null"><span>还没有加入任何小组</span></div>
                    <?php endif; ?>
