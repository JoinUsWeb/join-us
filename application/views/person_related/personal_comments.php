            ...
            <?php foreach ($activities_info as $single_activity): ?>
                ...
                <div class="p_hd_main">
                    ...
                    <div class="p_hd_present">
                        ...
                        <div class="p_hd_bd"><a class="thisover" href="../html/details_page.html">（活动简介大约100字左右）我们在用户注册时提供一级兴趣选择（一级兴趣包括：娱乐、体育、科技、美食、军事、历史、社会、旅游、影视、其他等，一级兴趣下再细化二级兴趣），多级区域选择，及其所处年龄层等信息。根据以上用户数据收集，推荐其喜好的活动。在推荐活动时，优先考虑二级兴趣标签及所在区域......</a>
                        </div>
                    </div>
                </div>
            <?php endforeach;
