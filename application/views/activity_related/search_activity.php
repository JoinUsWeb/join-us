                ...
                <div class="frame" id="frame1">
                    ...
                    <ul class="style1">
                        ...
                        foreach ($first_label as $first_label_item) {
                            ...
                            . '&city=' . $select['city']
                            . '"><b style="color : rbg(205,237,18);">' . $first_label_item['name'] . '</b></a></li>';
                            else
                        ...
                        foreach ($time as $time_item) {
                            ...
                            if ($select['time'] == $time_item[0])
                                echo '0'. '&city=' . $select['city']
                                    . '"><b style="color : rbg(205,237,18);">' . $time_item[1] . '</b></a></li>';
                            else
            ...
            if (!empty($activity))
                ...
                <div class="search_main">
                    ...
                    <div class="search_main_div">
                        ...
                        <div class="hd_time"><i class="icon-calendar "></i><span><?php echo $activity_item['date_start'] . '-' . $activity_item['time_start']?></span>
                        </div>
