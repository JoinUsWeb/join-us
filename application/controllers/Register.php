...
class Register extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('_email', 'Email', 'trim|htmlspecialchars|
            required|valid_email', array(
        ...
        $this->form_validation->set_rules('_password2', "Password", 'trim|htmlspecialchars|
            required|match[_password]', array(
            'required' => 'Please type your password again!',
            'match' => "Fail to match!"
        ));

        $this->form_validation->set_rules('_phoneNumber', 'Phone number', 'trim|htmlspecialchars|
            required|is_natural', array(
            'required' => 'Please provide your phone number!',
            'is_natural' => 'Invalid phone number!'
        ));

        $this->form_validation->set_rules('_nickName', 'Nickname', 'trim|htmlspecialchars|
            required|is_unique[user.nick_name]', array(
